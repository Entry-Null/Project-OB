...
local function Format_Beautify(ast)
    ...
    local formatStatement = function(statement)
        ...
        elseif statement.AstType == "ReturnStatement" then
            out = dead(95) .. getIndentation() .. dead(96) .. "return " --no
        ...
        elseif statement.AstType == "BreakStatement" then
            out = dead(103) .. getIndentation() .. dead(104) .. "break" .. dead(105)
        ...
        elseif statement.AstType == "GenericForStatement" then
            ...
            for i = 1, #statement.Generators do
                ...
                if i ~= #statement.Generators then
                    out = dead(171) .. joinStatementsSafe(dead(172) .. out .. dead(173), dead(174) .. "\44 " .. dead(175)) .. dead(176)
                end
            end
